...
<body class="bg-slate-50 overflow-x-hidden">
    ...
    <nav class="flex justify-between items-center px-6 lg:px-12 py-6 bg-white/80 backdrop-blur-md sticky top-0 z-50 border-b border-slate-100">
        ...
        <div class="hidden md:flex items-center gap-10 font-bold text-sm tracking-wider text-slate-600">
            ...
            <a href="/daftar" class="hover:text-indigo-600 transition">PENDAFTARAN</a>
        ...
        <div class="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="space-y-10">
                ...
                <div class="flex flex-wrap items-center gap-8">
                    <button onclick="window.location.href='/daftar'" class="group flex items-center gap-3 bg-slate-900 text-white px-8 py-5 rounded-2xl text-lg font-bold hover:bg-indigo-700 transition-all duration-300 shadow-2xl">
...
<section class="py-24 bg-slate-50">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="space-y-6">
                    ...
                    <p class="text-slate-500 text-lg leading-relaxed">
                        Pantau distribusi industri kecil menengah di setiap wilayah. Data ini membantu pemerintah dalam mengambil kebijakan yang tepat sasaran untuk akselerasi ekonomi lokal.
                    </p>
    ...
    <script>
        ...
        // Membuat gradient untuk bar grafik
        const gradient = ctx.createLinearGradient(0, 0, 0, 400);
        gradient.addColorStop(0, 'rgba(99, 102, 241, 1)');   // Indigo
        gradient.addColorStop(1, 'rgba(168, 85, 247, 0.2)'); // Purple Transparent
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Jumlah IKM',
                    data: [185, 142, 173], // Data simulasi
...
<footer class="bg-slate-900 text-white pt-20 pb-10">
        <div class="container mx-auto px-6 lg:px-24">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                ...
                <div class="space-y-6">
                    ...
                    <p class="text-slate-400 text-sm leading-relaxed">
                        Akselerasi Industri Lokal Madiun menuju pasar Global. Di bawah naungan Dinas Tenaga Kerja, Koperasi Usaha Kecil dan Menengah Kota Madiun.
                    </p>
                    <div class="space-y-3">
                        <h4 class="font-bold text-white uppercase text-xs tracking-widest">Alamat Kantor</h4>
                        <p class="text-slate-400 text-sm italic">
                            Jl. Bolodewo No.8, Kartoharjo, Kec. Kartoharjo, Kota Madiun, Jawa Timur 63117
                        </p>
                        <div class="rounded-2xl overflow-hidden h-32 mt-4 grayscale opacity-70 hover:grayscale-0 hover:opacity-100 transition duration-500">
                            <iframe 
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m12!1m3!1d3954.5123456789!2d111.5299176!3d-7.6276934!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e79be713125489b%3A0xe0d2eacecaf4e894!2sDinas%20Tenaga%20Kerja%20Kota%20Madiun!5e0!3m2!1sid!2sid!4v1700000000000!5m2!1sid!2sid" 
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-slate-800/50 p-6 rounded-2xl space-y-4 border border-slate-700">
                        ...
                        <div class="pt-2 border-t border-slate-700">
                            <p class="text-[10px] text-slate-500 uppercase font-bold tracking-tighter">Terakhir diperbarui: Hari ini</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex gap-4 pt-4">
                        <a href="#" class="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-indigo-600 transition duration-300">
            ...
            <div class="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4 text-slate-500 text-xs font-medium">
                <p>© 2026 IKM JUARA Kota Madiun. All rights reserved.</p>
